...
//Yamil Kas-Danouche
//10/5/2020
// this program was made with the purpose of making a system of arrays that will have a maximum size of 5 and ask the user to enter the value of sales for the week.
#include<iostream>
#include<iomanip>
